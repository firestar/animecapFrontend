...
export class ShowCreate {
  constructor(public envService:EnvironmentService, private showService:ShowService, private account: AccountService, private router: Router, private ftpService:FTPService){}
  accountData = null;
  allowed = false;
  workingpath = null;
  paths = null;
  ...
  ngOnInit(){
    ...
    self.account.executeWhenLoggedIn(function () {
      self.accountData = self.account.user().data;
