...
export class ShowService {
  ...
  private showFetch = "//animecap.com/api/show/list";
  private showInfoFetch = "//animecap.com/api/show/info";
  private showCreateFetch = "//animecap.com/api/show/create";
  private showFavoriteFetch = "//animecap.com/api/show/favorite";
